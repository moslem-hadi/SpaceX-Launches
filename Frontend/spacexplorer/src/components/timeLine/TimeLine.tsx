    ...
    <ul className="timeline">
      <li className="timeline-event">
        <div>
          ...
          <div className="timeline-event-copy">
            <p className="timeline-event-thumbnail">2006-03-24 - FalconSat</p>
      ...
      <li className="timeline-event">
        <div>
          <label className="timeline-event-icon"></label>
          <div className="timeline-event-copy">
            <p className="timeline-event-thumbnail">2006-03-24 - Trailblazer</p>
            <h3>Falcon 1 - Merlin A </h3>
            <h4>merlin engine failure</h4>
            <p>
              <strong>Details</strong>
              <br />
              residual stage-1 thrust led to collision between stage 1 and stage
              2
            </p>
          </div>
        </div>
